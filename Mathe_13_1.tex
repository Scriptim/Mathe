...
\begin{gather*}
  ...
  P(a \leq k \leq b) = F_{n; p}(b) - F_{n; p}(a) \approx \int_{x_1}^{x_2} \varphi(x) \cdot dx \\
...
\begin{exercise}{545/9}
  ...
  \begin{gather*}
    P(65 \leq X \leq 85) \\
    a = 65 \qquad b = 85 \\
    x_1 \approx \frac{65 - \frac{1}{2} - \mu}{\sigma} \approx -1.20020 \qquad x_2 \approx \frac{85 + \frac{1}{2} - \mu}{\sigma} \approx 3.38238 \\
    P(65 \leq k \leq 85) \approx \Phi(3.38) - \Phi(-1.20) \approx 99.96\% - 11.51\% = 88.45\% \\
    \text{(wahrer Wert: $88.38\%$)}
  \end{gather*}
  \item [d]
  \begin{gather*}
    P(X \geq 80) \\
    ...
    P(80 \leq k \leq 100) \approx 1 - \Phi(2.07) \approx 1 - 98.07\% = 1.93\% \\
