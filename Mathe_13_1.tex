...
\end{gather*}
\subsubsection*{AB Exponentialfunktionen}
\begin{exercise}{AB/3}
  \begin{gather*}
...
\begin{exercise}{514/5}
  ...
  \end{gather*}
\end{exercise}
\subsection{Signifikanztest (einseitig)}
...
\begin{exercise}{522/2}
  ...
  \end{gather*}
\end{exercise}
\subsubsection{Mögliche Fehler beim Testen}
\begin{itemize}
...
\begin{exercise}{525/1}
  ...
  \end{gather*}
\end{exercise}
\subsection{Näherung durch die Normalverteilung}
...
\chapter{Rationale Funktionen}
\begin{gather*}
  \text{rationale Funktionen}
  \begin{cases}
    \text{ganzrationale Funktionen} \\
    \text{gebrochenrationale Funktionen}
  \end{cases}
\end{gather*}
Beispiel:
\begin{gather*}
  f(x) = \frac{x - 1}{x - 2} \qquad D = \mathbb{R}\setminus{2}
\end{gather*}
Bei $x = 2$ liegt ein Pol mit Vorzeichenwechsel (VZW $- \rightarrow +$) vor. Ein Pol ist eine Unendlichkeitsstelle. Der Graph hat eine waagerechte Asymptote $y = 1$, d. h. eine Gerade, an die sich der Funktionsgraph anschmiegt. Zu jedem Pol gibt es eine senkrechte Asymptote, hier mit der Gleichung $x = 2$.
\begin{gather*}
  \begin{tikzpicture}
    \begin{axis}[
      axis lines=middle,
...
\end{gather*}
\newpage
\begin{exercise}{209/3}
  \item [a]
  \begin{gather*}
    f(x) = \frac{1}{x - 3} \qquad D = \mathbb{R}\setminus\{3\}
  \end{gather*}
  \begin{gather*}
    \begin{tikzpicture}
      \begin{axis}[
  ...
  \item [b]
  \begin{gather*}
    f(x) = \frac{2}{x + 3} \qquad D = \mathbb{R}\setminus\{-3\}
  \end{gather*}
  \begin{gather*}
    \begin{tikzpicture}
      \begin{axis}[
  ...
  \item [c]
  \begin{gather*}
    f(x) = \frac{1}{2x - 3} \qquad D = \mathbb{R}\setminus\{1.5\}
  \end{gather*}
  \begin{gather*}
    \begin{tikzpicture}
      \begin{axis}[
  ...
  \item [d]
  \begin{gather*}
    f(x) = \frac{x}{1 + x} \qquad D = \mathbb{R}\setminus\{-1\}
  \end{gather*}
  \begin{gather*}
    \begin{tikzpicture}
      \begin{axis}[
  ...
  \end{gather*}
\end{exercise}
\section{Asymptoten, Kurvendiskussion}
\subsection{Asymptoten}
Beispiele:
\begin{gather*}
  f(x) = \frac{x}{x^2 - 4} \qquad \lim\limits_{x \to \pm\infty} f(x) = 0 \qquad y = 0 \text{ ist Asymptote} \\
  g(x) = \frac{2x - 3}{x + 1} \qquad \lim\limits_{x \to \pm\infty} g(x) = 2 \qquad y = 2 \text{ ist Asymptote} \\
  h(x) = \frac{x^2 - 4}{x + 5} \qquad \lim\limits_{x \to \pm\infty} h(x) = \pm\infty \qquad y = x - 5 \text{ ist Asymptotenfunktion (s. u.)}
\end{gather*}
Polynomdivision zur Ermittlung der Asymptote: \\
\polylongdiv[style=C]{x^2 - 4}{x + 5} \\\\
ganzrationaler Teil $x - 5$ bestimmt das Verhalten für $x \to \pm\infty$ \\
gebrochenrationaler Teil $\frac{21}{x + 5}$ enthält die Polstellen
\begin{gather*}
  \begin{tikzpicture}
    \begin{axis}[
      axis lines=middle,
...
\newpage
\begin{gather*}
  i(x) = \frac{x^3 - 2x^2 + 5x - 7}{x - 1}
\end{gather*}
\polylongdiv[style=C]{x^3 - 2 * x^2 + 5 * x - 7}{x - 1} \\\\
\begin{gather*}
  \begin{tikzpicture}
    \begin{axis}[
      axis lines=middle,
  ...
  \end{tikzpicture}
\end{gather*}
\subsection{Nullstellen von Zähler- bzw. Nennerpolynom}
\begin{gather*}
  f(x) = \frac{x \cdot (x - 2)}{x - 2} = x \qquad D = \mathbb{R}\setminus\{2\} \\
  f^*(x) = \begin{cases}
    x & \text{für $x \neq 2$} \\
    2 & \text{für $x = 2$}
  \end{cases} \\
  \text{gemeinsame Nullstelle des Zähler- und Nennerpolynoms}
\end{gather*}
\begin{gather*}
  \begin{tikzpicture}
    \begin{axis}[
...
\end{gather*}
\begin{gather*}
  g(x) = \frac{1}{x - 2} \qquad \text{NS des Nenners $\Rightarrow$ Polstelle} \\
  \text{Grad der Nullstelle ungerade: Pol mit Vorzeichenwechsel} \\
  \text{Grad der Nullstelle gerade: Pol ohne Vorzeichenwechsel}
\end{gather*}
\begin{gather*}
  h(x) = \frac{1 \cdot (x - 2)}{x - 2} = \frac{1}{x - 2} \\
  \text{trotz gemeinsamer Nullstelle Pol mit Vorzeichenwechsel bei $x - 2$}
\end{gather*}
\begin{exercise}{212/1}
  \item [i]
  \begin{gather*}
    f(x) = \frac{x^2 + 9}{x + 2} \qquad D = \mathbb{R}\setminus\{-2\} \\
    \text{Nullstellen: } \{\} \\
    \text{Polstellen: } \{-2\} \text{ (mit VZW)} \\
    \text{Achsenschnittpunkte: } S_y(0|f(9) = 4.5) \\
    \text{senkr. Asymptoten: } x = -2
  \end{gather*}
  \item [j]
  \begin{gather*}
    f(x) = \frac{x - 2}{x^2 + 2x + 1} \qquad D = \mathbb{R}\setminus\{-1\} \\
    \text{Nullstellen: } \{2\} \\
    \text{Polstellen: } \{-1\} \text{ (ohne VZW)} \\
    \text{Achsenschnittpunkte: } S_x(2|0),\;S_y(0|f(0) = -2) \\
    \text{senkr. Asymptoten: } x = -1
  \end{gather*}
  \item [k]
  \begin{gather*}
    f(x) = \frac{x^2 - x}{x^2 - x - 6} \qquad D = \mathbb{R}\setminus\{-2, 3\} \\
    \text{Nullstellen: } \{0, 1\} \\
    \text{Polstellen: } \{-2, 3\} \text{ (mit VZW)} \\
    \text{Achsenschnittpunkte: } S_x(0|0),\;S_x(1|0)\;S_y(0|f(0) = 0) \\
    \text{senkr. Asymptoten: } x = -2,\;x = 3
  \end{gather*}
\end{exercise}
\begin{exercise}{221/1}
  \item [b]
  \begin{gather*}
    f(x) = \frac{2 - x^2}{x^2 - 9} \\
    \text{Definitionsmenge: } \mathbb{R}\setminus\{\pm 3\} \\
    \text{Symmetrie: } f(-x) = f(x) \quad\Rightarrow\quad \text{achsensymmetrisch zur $y$-Achse} \\
    \text{Polstellen, senkr. Asymptoten: } x = 3,\;x = -3 \quad\text{(mit VZW)} \\
    \text{Grenzverhalten: } \lim\limits_{x \to \pm\infty} f(x) = -1 \\
    \text{Nullstellen: } \{\pm\sqrt{2}\} \\
    \text{Ableitungen: } f'(x) = \frac{14x}{(x^2 - 9)^2},\;f''(x) = \frac{42(x^2 + 3)}{(x^2 - 9)^3} \\
    \text{Extremstellen: } TP(0|-\frac{2}{9}) \\
    \text{Wendestellen: } \{\}
  \end{gather*}
  \begin{gather*}
    \begin{tikzpicture}
