...
\begin{exercise}{321/3}
  \item [a]
  \begin{gather*}
    g: \vv{x} = \begin{pmatrix}3 \\ 3 \\ 1\end{pmatrix} + s \cdot \begin{pmatrix}7 \\ 17 \\ 2\end{pmatrix} \\
    \begin{pmatrix}7 \\ 17 \\ 2\end{pmatrix} \cdot \vv{a} = 0 \\
    7a_1 + 17a_2 + 2a_3 = 0 \\
    \text{z. B. } \vv{a} = \begin{pmatrix}2 \\ 0 \\ -7\end{pmatrix} \\
    h: \vv{x} = \begin{pmatrix}3 \\ 3 \\ 1\end{pmatrix} + s \cdot \begin{pmatrix}2 \\ 0 \\ -7\end{pmatrix}
  \end{gather*}
\end{exercise}
...
\begin{exercise}{366/3}
  ...
  \begin{gather*}
    ...
    \vv{a} \cdot \vv{b} = b \gap\gap |\vv{a}| \cdot |\vv{b}| = \sqrt{3 + b} \\
    \alpha = 30^\circ = acos(\frac{\sqrt{3}}{2}) \gap\Rightarrow\gap \frac{b}{\sqrt{3 + b}} = \frac{\sqrt{3}}{2} \gap\Rightarrow\gap b = 3
  \end{gather*}
  \item [c]
  \begin{gather*}
    ...
    \alpha = 30^\circ = acos(\frac{1}{2}) \gap\Rightarrow\gap \frac{c}{2 \cdot \sqrt{0.5} \cdot \sqrt{1 + c^2}} = \frac{1}{2} \gap\Rightarrow\gap c \approx 1
  \end{gather*}
\end{exercise}
