...
Da $\Bigl|\left\{\vv{a}; \vv{b}; \vv{c}\right\}\Bigl| = 3$ ist der $\mathbb{R}^3$ dreidimensional.
...
\begin{exercise}{373/3}
  ...
  \begin{gather*}
    ...
    \Biggl|\begin{pmatrix}1 \\ -1 \\ 1\end{pmatrix}\Biggl| = \sqrt{1^2 + (-1)^2 + 1^2} = \sqrt{3} \\
  ...
  \begin{gather*}
    ...
    \Biggl|\begin{pmatrix}-14 \\ 26 \\ 61\end{pmatrix}\Biggl| = \sqrt{(-14)^2 + 26^2 + 61^2} = \sqrt{4593} \\
...
\begin{exercise}{374/6}
  ...
  \begin{gather*}
    ...
    V_S = \Biggl|\begin{pmatrix}-1 \\ 5 \\ 6\end{pmatrix} \times \begin{pmatrix}8 \\ 2 \\ 1\end{pmatrix} \cdot \begin{pmatrix}-2 \\ 0 \\ 5\end{pmatrix}\Biggl| = \Biggl|\begin{pmatrix}-7 \\ 49 \\ -42\end{pmatrix} \cdot \begin{pmatrix}-2 \\ 0 \\ 5\end{pmatrix}\Biggl| = -196 \\
  ...
  \begin{gather*}
    ...
    V_S = \Biggl|\begin{pmatrix}1 \\ 7 \\ 1\end{pmatrix} \times \begin{pmatrix}-8 \\ 8 \\ 18\end{pmatrix} \cdot \begin{pmatrix}7 \\ 2 \\ 2\end{pmatrix}\Biggl| = \Biggl|\begin{pmatrix}118 \\ -26 \\ 64\end{pmatrix} \cdot \begin{pmatrix}7 \\ 2 \\ 2\end{pmatrix}\Biggl| = 902 \\
