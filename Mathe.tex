...
\subsection{Berechnung von Integralen, Hauptsatz}
...
\end{gather*}
\subsubsection{Verallgemeinerung (Hauptsatz der Differenzial- und Integralrechnung)}
\begin{gather*}
...
\begin{exercise}{167/3}
  ...
  \end{gather*}
\end{exercise}
\subsection{Integrale lösen - Anwendung}
...
\end{gather*}
\subsection{bestimmtes Integral, Integralfunktion, unbestimmtes Integral}
\begin{gather*}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{/fakepath/integral_flaecheninhalt_1.png}
\end{figure}
\begin{gather*}
  A = A_1 + A_2 \\
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{/fakepath/integral_flaecheninhalt_2.png}
\end{figure}
\begin{gather*}
  A = A_1 + A_2 \\
...
\begin{exercise}{180/5}
  ...
  \begin{gather*}
    ...
    \;= |[-1.25x^2 + 5.25x + 1/x]_{0.5}^2| \approx 1.7FE
  \end{gather*}
\end{exercise}
...
\begin{exercise}{180/11}
  ...
  \end{gather*}
\end{exercise}
\subsection{Integration von Produkten: partielle Integration}
...
\end{gather*}
\begin{gather*}
  \int e^{2x} \cdot x^2 \cdot dx = \frac{1}{2}e^{2x} \cdot x^2 - \int \frac{1}{2}e^{2x} \cdot dx \\
...
\begin{exercise}{188/1}
  \item [a]
  \begin{gather*}
    \int_{-1}^{1} e^x \cdot x \cdot dx = \left[e^x \cdot x - \int e^x \cdot 1 \cdot dx\right]_{-1}^{1} = \left[e^x \cdot x - e^x\right]_{-1}^{1} = \frac{2}{e}
  \end{gather*}
  \item [d]
  \begin{gather*}
    \int_{0}^{0.5} e^{2x + 2} \cdot 4x \cdot dx = \left[\frac{1}{2}e^{2x + 2} \cdot 4x - \int \frac{1}{2}e^{2x + 2} \cdot 4 \cdot dx \right]_{0}^{0.5} \\
...
\begin{exercise}{188/2}
  \item [b]
  \begin{gather*}
    \int_0^\pi cos(x) \cdot x \cdot dx = \left[sin(x) \cdot x - \int sin(x) \cdot 1 \cdot dx\right]_0^\pi \\
    \;= \left[sin(x) \cdot x + cos(x)\right]_0^\pi = -2
  \end{gather*}
  \item [d]
  \begin{gather*}
    \int_0^{2\pi} sin(0.5x) \cdot 2x \cdot dx = \left[-2cos(0.5x) \cdot 2x - \int -2cos(0.5x) \cdot 2 \cdot dx\right]_0^{2\pi} \\
...
\begin{exercise}{188/8}
  \item [a]
  \begin{gather*}
    \int_0^\pi (sin(x))^2 \cdot dx = \left[-cos(x) \cdot sin(x) - \int -cos(x) \cdot cos(x) \cdot dx\right]_0^\pi \\
    \;= \left[-cos(x) \cdot sin(x) - \int (-sin^2(x) - 1) \cdot dx\right]_0^\pi \\
    \;= \left[-cos(x) \cdot sin(x) + x - \int sin^2(x) \cdot dx\right]_0^\pi \equ + \int_0^\pi sin^2(x) \cdot dx; \gap : 2 \\
    \;= \left[\frac{-cos(x) \cdot sin(x) + x}{2}\right]_0^\pi = \frac{\pi}{2}
  \end{gather*}
  \item [c]
  \begin{gather*}
    \int_{-2}^2 e^x \cdot cos(x) \cdot dx = \left[sin(x) \cdot e^x - \int sin(x) \cdot e^x \cdot dx\right]_{-2}^2 \\
    \;= \left[sin(x) \cdot e^x - (-cos(x) \cdot e^x - \int -cos(x) \cdot e^x \cdot dx)\right]_{-2}^2 \\
    \;= \left[sin(x) \cdot e^x + cos(x) \cdot e^x - \int cos(x) \cdot e^x \cdot dx\right]_{-2}^2 \\
    \;= \left[\frac{(sin(x) + cos(x)) \cdot e^x}{2}\right]_{-2}^2 \approx 1.912
  \end{gather*}
  \item [d]
  \begin{gather*}
    \int_0^2 sin(\pi x) \cdot e^{2x} \cdot dx = \left[\frac{1}{2}e^{2x} \cdot sin(\pi x) - \int \frac{1}{2}e^{2x} \cdot \pi \cdot cos(\pi x) \cdot dx\right]_0^2 \\
    \;= \left[\frac{1}{2}e^{2x} \cdot sin(\pi x) - (\frac{1}{4}e^{2x} \cdot \pi \cdot cos(\pi x) - \int -\frac{1}{4}e^{2x} \cdot \pi^2 \cdot sin(\pi x) \cdot dx)\right]_0^2 \\
    \;= \left[\frac{1}{2}e^{2x} \cdot sin(\pi x) - (\frac{1}{4}e^{2x} \cdot \pi \cdot cos(\pi x) + \frac{1}{4}\pi^2 \cdot \int e^{2x} \cdot sin(\pi x) \cdot dx)\right]_0^2 \\
...
\begin{exercise}{AB/23}
  ...
  \begin{gather*}
    ...
    \;= \int_{e^0}^{e^1} e^{ln(t)} \cdot \sqrt{e^{ln(t)} + 1} \cdot \frac{1}{t} \cdot dz = \int_1^e \sqrt{t + 1} \\
...
\subsubsection{Bestimmung des Volumens von Rotationskörpern}
\begin{gather*}
  f(x) = \frac{1}{2}x^2 + 1
\end{gather*}
\begin{figure}[H]
...
\section{Analytische Geometrie: Punkte und Vektoren}
...
\begin{gather*}
  ...
  \end{tikzpicture}
\end{gather*}
\subsubsection{Darstellung im 3-dimensionalen Koordinatensystem}
...
\begin{exercise}{276/10}
  ...
  \end{gather*}
\end{exercise}
\subsection{Ortsvektoren und Verschiebungsvektoren}
