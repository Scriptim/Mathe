...
\begin{gather*}
  \vec{OM_1} = \vec{OA} + \frac{1}{2} \cdot \vec{AB} = \vec{OB} - \frac{1}{2}\vec{AB} \\
  \vec{OM_2} = \vec{OA} + \frac{1}{2} \cdot \vec{AC} = \vec{OC} - \frac{1}{2}\vec{AC}
\end{gather*}
\begin{itemize}
  \item [zu 6a]
  \begin{gather*}
    \vec{OA} = \begin{pmatrix}-2 \\ 2 \\ 3\end{pmatrix} \gap\gap \vec{OB} = \begin{pmatrix}5 \\ 5 \\ 5\end{pmatrix} \gap\gap \vec{OC} = \begin{pmatrix}9 \\ 6 \\ 5\end{pmatrix} \\
    \vec{OM_1} = \begin{pmatrix}-2 \\ 2 \\ 3\end{pmatrix} + \frac{1}{2} \cdot \begin{pmatrix}7 \\ 3 \\ 2\end{pmatrix} = \begin{pmatrix}1.5 \\ 3.5 \\ 4\end{pmatrix} \\
    \vec{OM_2} = \begin{pmatrix}-2 \\ 2 \\ 3\end{pmatrix} + \frac{1}{2} \cdot \begin{pmatrix}11 \\ 4 \\ 2\end{pmatrix} = \begin{pmatrix}3.5 \\ 4 \\ 4\end{pmatrix}
  \end{gather*}
  \item [zu 6b]
  \begin{gather*}
    \vec{OA} = \begin{pmatrix}2 \\ 0 \\ 3\end{pmatrix} \gap\gap \vec{OB} = \begin{pmatrix}4 \\ 4 \\ 4\end{pmatrix} \gap\gap \vec{OC} = \begin{pmatrix}11 \\ 7 \\ 9\end{pmatrix} \\
    \vec{OM_1} = \begin{pmatrix}2 \\ 0 \\ 3\end{pmatrix} + \frac{1}{2} \cdot \begin{pmatrix}2 \\ 4 \\ 1\end{pmatrix} = \begin{pmatrix}3 \\ 2 \\ 3.5\end{pmatrix} \\
    \vec{OM_2} = \begin{pmatrix}2 \\ 0 \\ 3\end{pmatrix} + \frac{1}{2} \cdot \begin{pmatrix}9 \\ 7 \\ 6\end{pmatrix} = \begin{pmatrix}6.5 \\ 3.5 \\ 6\end{pmatrix}
  \end{gather*}
\end{itemize}
...
\begin{exercise}{284/11}
  \item [f] $-(\vec{u} - \vec{v}) = \vec{v} - \vec{u}$
  \item [g] $2(2\vec{a} + 4\vec{b}) = 4\vec{a} + 8\vec{b}$
  \item [h] $-4(\vec{a} - \vec{b}) - \vec{b} + \vec{a} = 5\vec{a} - 5\vec{b}$
  \item [i] $3(\vec{a} + 2(\vec{a} + \vec{b})) = 9\vec{a} + 6\vec{b}$
  \item [j] $6(\vec{a} - \vec{b}) + 4(\vec{a} + \vec{b}) = 10\vec{a} - 2\vec{b}$
  \item [k] $7\vec{u} + 5(\vec{u} - 2(\vec{u} + \vec{v})) = 2\vec{u} + 10\vec{v}$
\end{exercise}
\begin{exercise}{284/12}
  \item [a] $\vec{AG} = \vec{a} + \vec{b} + \vec{c}$
  \item [b] $\vec{BH} = -\vec{a} + \vec{b} + \vec{c}$
  \item [c] $\vec{EC} = \vec{a} + \vec{b} - \vec{c}$
  \item [d] $\vec{ME} = -\frac{1}{2}\vec{a} - \frac{1}{2}\vec{b} + \vec{c}$
\end{exercise}
