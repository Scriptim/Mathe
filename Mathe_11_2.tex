...
\begin{exercise}{112/5}
  $$O(t) = -\frac{1}{300}(t^3 - 36t^2 + 324t - 5700) \qquad t \in \left[0; 24\right]$$
  \item [a]
  \begin{gather*}
    ...
    t_1 = 6 \qquad t_2 = 18 \\\\
    O''(t) = \frac{12 - t}{50} \\
    O''(t_1) = \frac{6}{50} > 0 \quad\Rightarrow\quad TP(6|O(6) = 16.12) \\
    O''(t_2) = \frac{-6}{50} < 0 \quad\Rightarrow\quad HP(18|O(18) = 19)
  \end{gather*}
  \item [b]
...
\begin{exercise}{115/8}
  \begin{gather*}
    ...
    U'(r) = 0 \qquad L = \{\pm 3.55\} \\
    r = 3.55m \\
    h = 3.55m \quad fuer \; r = 3.55m
  \end{gather*}
\end{exercise}
\begin{exercise}{115/11}
  \begin{gather*}
    ...
    V'(h) = 0 \qquad L = \{\pm 6.93\} \\
    h = 6.93cm \\
    r = 4.9 cm \quad fuer \; h = 6.93cm
  \end{gather*}
\end{exercise}
...
\begin{exercise}{115/13}
  ...
  \begin{gather*}
    ...
    T'(b) = -3b^2 + 10000 \\
    T'(b) = 0 \qquad L = \{\pm \frac{100}{\sqrt{3}}\} \\
...
\begin{gather*}
  ...
  \qquad f(1) = -4 \\
  \qquad f(2) = 8 \\
  \qquad \Rightarrow \text{Nullstelle zwischen 1 und 2} \\
...
\begin{gather*}
  ...
  t(x_1) = 0 \qquad x_1 = x_0 - \frac{f(x_0)}{f'(x_0)} \\
...
\begin{exercise}{118/4}
  ...
  \item [b]
  \begin{gather*}
    g(x) = x^3; \quad h(x) = \frac{1}{2}x^3 - 2x + 2 \\
...
\begin{exercise}{118/5}
  ...
  \item [b]
  \begin{gather*}
    f(x) = -0.1x^4 - x^3 + x^2 + 3; \quad m = -18 \\
  ...
  \item [c]
  \begin{gather*}
    f(x) = \frac{1}{10}x^3 + \frac{1}{2}x^2 - 1 + \frac{1}{x}; \quad m = 4 \\
  ...
  \item [d]
  \begin{gather*}
    f(x) = \sqrt{x} - \frac{1}{2}x^3 + 3; \quad m = -10 \\
...
\begin{exercise}{AB/1}
  ...
  \begin{gather*}
    ...
    \textbf{Extrema} \\
    f_a'(x) = 2x - 2a = 0 \quad L = \{a\} \\
    f_a''(x) = 2 > 0 \quad \Rightarrow TP(a|f_a(a) = -a^2 + 1) \\
    \textbf{Wendepunkte} \\
    f_a''(x) = 0 \quad L = \{\}
  \end{gather*}
  \item [b]
  ...
  \item [c]
  \begin{gather*}
    f_a'(4) = 2 \cdot 4 - 2a = 1 \quad\Rightarrow a = 3.5
  \end{gather*}
  \item [d]
  \begin{gather*}
    x_{1/2} = a \pm \sqrt{a^2 - 1} \\
    a^2 - 1 < 0 \quad fuer \; a < 1 \quad \Rightarrow \text{ keine Nullstelle} \\
    a^2 - 1 = 0 \quad fuer \; a = 1 \quad \Rightarrow \text{ 1 Nullstelle} \\
    a^2 - 1 > 0 \quad fuer \; a > 1 \quad \Rightarrow \text{ 2 Nullstellen}
  \end{gather*}
\end{exercise}
\newpage
...
\begin{exercise}{AB/5}
  ...
  \begin{gather*}
    ...
    \textbf{Wendepunkte} \\
    f_a''(x) = 0 \quad L = \{\pm\sqrt{\frac{a}{3}}\} \\
    f_a'''(x) = 12x \\
...
\begin{exercise}{115/9}
  \begin{gather*}
    O(a, h) = a^2 + 4ah \\
    V(a, h) = a^2 \cdot h = 40dm^3 \quad\Rightarrow h = \frac{40dm^3}{a^2} \\
...
\begin{gather*}
  f(\alpha) = sin(\alpha) \\
  f(x) = sin(x) \\\\
  \frac{\alpha}{360^\circ} = \frac{x}{U} \qquad U = 2\pi r \\\\
  x = \frac{\alpha \cdot 2\pi}{360^\circ} \qquad \alpha = \frac{x \cdot 360^\circ}{2\pi} \\\\
  \text{wichtige x-Koordinaten} \\
  x = 3.14... = \pi \qquad x = 6.28... = 2\pi \\
  x = 1.57... = \frac{\pi}{2} \qquad x = 4.71... = \frac{3\pi}{2} \\\\
  sin(x + \frac{\pi}{2}) = cos(x) \qquad sin(x) = cos(x - \frac{\pi}{2}) \\\\
\end{gather*}
...
\end{exercise}
\begin{exercise}{AB/6}
  $$f(t) = a \cdot sin(b(t - c)) \qquad -2 \leq t \leq 13$$
  \item [a]
...
\begin{exercise}{130/4}
  \item [c]
  \begin{gather*}
    f(x) = 2 \cdot sin(x) - cos(x); \quad x \in \left[0; 2\pi\right] \\
    f'(x) = 2 \cdot cos(x) + sin(x) \\\\
    f'(x) = 0 = 2 \cdot cos(x) + sin(x) \\
    2 = -\frac{sin(x)}{cos(x)} = -tan(x) \quad\Rightarrow\quad x = atan(-2) \\
    L = \{atan(-2) + n\pi\} \quad n \in \{1; 2\} \\\\
  ...
  \item [d]
  \begin{gather*}
    f(x) = 4 \cdot cos(x) + 2x; \quad x \in \left[0; 2\pi\right] \\
    f'(x) = -4 \cdot sin(x) + 2 \\\\
    f'(x) = 0 = -4 \cdot sin(x) + 2 \\
    0.5 = sin(x) \quad\Rightarrow\quad x = asin(0.5) \\
...
\begin{gather*}
  {\color{blue}f(x) = 2^x} \qquad {\color{cyan}f'(x)} \qquad\qquad {\color{red}g(x) = 4^x} \qquad {\color{purple}g'(x)}\\
\end{gather*}
\begin{gather*}
  \begin{tikzpicture}
    \begin{axis}[
...
\begin{gather*}
  ...
  e^z = 10 \quad\Rightarrow\quad z = ln(10) \\
  \Rightarrow\quad b^x = e^{ln(b) \cdot x} \\\\
  f'(x) = e^{ln(10) \cdot x} \cdot ln(10) \\
  \;= 10^x \cdot ln(10) \\
  \Rightarrow\quad b^x \cdot ln(b)
\end{gather*}
\begin{exercise}{145/8}
  ...
  \begin{gather*}
    ...
    z_1 = 4 \quad z_2 = 2.5 \equ \text{resubst.} \\\\
    z_1 = 4 = e^x \equ ln \\
  ...
  \begin{gather*}
    ...
    z_1 = 4 \quad z_2 = 2 \equ \text{resubst.} \\\\
    z_1 = 4 = e^x \equ ln \\
    x_1 = ln(4) \approx 1.386 \\\\
    z_2 = 2 \equ ln \\
  ...
  \begin{gather*}
    ...
    z_1 = 5 \quad (z_2 = -3) \equ \text{resubst.} \\\\
    z_1 = 5 = e^x \equ ln \\
  ...
  \begin{gather*}
    ...
    z_1 = 0.5 \quad (z_2 = -8) \equ \text{resubst.} \\\\
    z_1 = 0.5 = e^x \equ ln \\
...
\begin{exercise}{130/8}
  \begin{gather*}
    P(x_0|f(x_0)) \qquad Q(x_0|g(x_0)) \qquad 0 \leq x \leq 2\pi
  \end{gather*}
  \item [a]
  \begin{gather*}
    f(x) = 2 \cdot sin(x) \qquad g(x) = x^2 \\
    f'(x) = 2 \cdot cos(x) \qquad g'(x) = 2x \\
  ...
  \item [b]
  \begin{gather*}
    f(x) = sin(x) + 2 \cdot cos(x) \qquad g(x) = x^3 \\
    f'(x) = cos(x) - 2 \cdot sin(x) \qquad g'(x) = 3x^2 \\
...
\begin{exercise}{138/3}
  \item [a]
  \begin{gather*}
    f(x) = (2x - 8) \cdot sin(x) \qquad f'(x) = 2 \cdot cos(x) \\
    f(x) = a \cdot b \qquad f'(x) = a' \cdot b + a \cdot b' \neq a' \cdot b' \\
    \Rightarrow \quad f'(x) = 2 \cdot sin(x) + (2x - 8) \cdot cos(x)
  \end{gather*}
  \item [b]
  \begin{gather*}
    g(x) = (2x - 3) \cdot (8 - x)^2 \\
...
\begin{gather*}
  ...
  \text{\Rmnum{3}} \quad 4x_2 = 8 \rightarrow x_2 = 2 \\
...
\begin{exercise}{256/4}
  ...
  \begin{gather*}
    ...
    \end{vmatrix}
    \qquad \Rmnum{3} - 2 \cdot \Rmnum{1} \\
    \begin{vmatrix}
      2x_1 & - & 4x_2 & + & 5x_3 & = & 3 \\
      {\color{red}0}x_1 & + & 18x_2 & - & 1x_3 & = & 17 \\
      {\color{red}0}x_1 & + & 6x_2 & - & 13x_3 & = & -7
    \end{vmatrix}
    \qquad 2 \cdot \Rmnum{2} - 3 \cdot \Rmnum{1}
  \end{gather*}
  ...
  \begin{gather*}
    \begin{vmatrix}
      ...
      && 6x_2 & - & 13x_3 & = & -7
    \end{vmatrix} \\
    \text{\Rmnum{2}} \quad 38x_3 = 38 \rightarrow x_3 = 1 \\
...
\begin{exercise}{256/4}
  ...
  \begin{gather*}
    \begin{vmatrix}
      ...
      4x_1 & - & x_2 & + & x_3 & = & 1 \\
      5x_1 & - & 3x_2 & + & x_3 & = & -1
    \end{vmatrix} \quad\longrightarrow\quad
    \begin{vmatrix}
      -1 & 7 & -1 & \vdots & 5 \\
      4 & -1 & 1 & \vdots & 1 \\
      5 & -3 & 1 & \vdots & -1
    ...
    \begin{vmatrix}
      ...
      3 & 6 & 0 & \vdots & 6 \\
      1 & -2 & 0 & \vdots & -2
    \end{vmatrix} \qquad \Rmnum{2} + \Rmnum{1}; \quad \Rmnum{3} - \Rmnum{2} \\
    \begin{vmatrix}
      -1 & 7 & -1 & \vdots & 5 \\
      3 & 6 & 0 & \vdots & 6 \\
      0 & 12 & 0 & \vdots & 12
    \end{vmatrix} \qquad \Rmnum{2} - 3 \cdot \Rmnum{3} \\\\
    ... \\
    L = \{0|1|2\}
  \end{gather*}
  \item [c]
...
\begin{gather*}
  ...
  x_3 = a \\
  \Rmnum{2} \quad -x_2 + 12a = 50 \rightarrow x_2 = 12a - 50 \\
  \Rmnum{1} \quad 3x_1 + 2(12a - 50) - 3a = 5 \rightarrow x_1 = -7a + 35 \\
  \begin{pmatrix}
    x_1 \\ x_2 \\ x_3
  \end{pmatrix} =
  \begin{pmatrix}
...
\begin{gather*}
  c = 5 \\
  10 = 6a + b \quad\Rightarrow\quad b = 10 - 6a \\
  5 = 4a + 2(10 - 6a) + 5 \quad\Rightarrow\quad a = 2.5 \\
  b = 10 - 6 \cdot 2.5 = -5
\end{gather*}
...
\begin{itemize}
  ...
  \begin{gather*}
    ...
    \Rightarrow\quad b = d = 0 \\
    g(x) = ax^5 + bx^4 + cx^3 + dx^2 + ex + f \\
    \Rightarrow\quad b = d = f = 0
  \end{gather*}
\end{itemize}
\begin{exercise}{262/1}
  \item [c]
  \begin{gather*}
    A(1|3) \qquad B(-1|2) \qquad C(3|2) \\
    y = ax^2 + bx + c \\
    3 = a + b + c \\
    2 = a - b + c \\
    2 = 9a + 3b + c \\\\
    a - b + c = 9a + 3b + c \quad\Rightarrow\quad a = -\frac{1}{2}b \\
    \frac{1}{2}b + c = -\frac{3}{2} + c + 1 \quad\Rightarrow\quad b = \frac{1}{2} \quad\Rightarrow\quad a = -\frac{1}{4} \\
    3 = -\frac{1}{4} + \frac{1}{2} + c \quad\Rightarrow\quad c = 2\frac{3}{4} \\\\
...
\begin{exercise}{262/4}
  \item [a]
  \begin{gather*}
    A(0|1) \qquad B(1|0) \qquad C(-1|4) \qquad D(2|-5) \\
    y = ax^3 + bx^2 + cx + d \\
    1 = d \\
    0 = a + b + c + d \\
    4 = -a + b - c + d \\
    -5 = 8a + 4b + 2c + d \\\\
    a + b + c = a + b - c + d + 8a + 4b + 2c + d \quad\Rightarrow\quad c = 2a + b \\
    4 = -a + b - 2a - b + d \quad\Rightarrow\quad a = -1 \quad\Rightarrow\quad b + c = 0 \\
    c = 2a + b \quad\Rightarrow\quad c = -1 \quad\Rightarrow\quad b = 1 \\\\
    y = -x^3 + x^2 - x + 1
  \end{gather*}
\end{exercise}
...
\begin{exercise}{262/3}
  ...
  \begin{gather*}
    ...
    \begin{vmatrix}
      ...
      4b &&&&& = & 0
    \end{vmatrix}
    \qquad \Rmnum{1} - \Rmnum{2} \\
    \Rightarrow\quad b = 0 \\
    4a + c = 0 \\\\
    \text{setze } a = k \\
    4k + c = 0 \quad\Rightarrow\quad c = -4k \\\\
    f_k(x) = kx^2 - 4k \qquad \text{Funktionenschar, Parameterfunktion}
  \end{gather*}
  \item [c]
  \begin{gather*}
    f(x) = ax^2 + bx + c \\
    ...
    16a - 4b - 4 = 0 \\\\
    a = k \\
    16k - 4b = 4 \quad\Rightarrow\quad b = 4k - 1 \\\\
    f_k(x) = kx^2 + 4kx - x - 4
  \end{gather*}
\end{exercise}
\begin{exercise}{262/8}
  \begin{gather*}
    f(x) = ax^4 + bx^3 + cx^2 + dx + e \\\\
    f(x) = -f(x) \quad\Rightarrow\quad b = d = 0 \\
    f(0) = -1 \quad\Rightarrow\quad e = -1 \\
    f(1) = -3 \qquad f'(1) = 0 \qquad f''(1) < 0 \\\\
    f(x) = ax^4 + bx^2 - 1 \\
    f(1) = a + b - 1 = -3 \quad\Rightarrow\quad a + b = -2 \\
    f'(x) = 4ax^3 + 2bx \\
    f'(1) = 4a + 2b = 2a - 4 = 0 \quad\Rightarrow\quad a = 2 \quad\Rightarrow\quad b = -4 \\\\
    f(x) = 2x^4 - 4x^2 - 1 \\\\
    f''(x) = 24x^2 - 8 \\
    f''(1) = 16 > 0 \\\\
...
\begin{exercise}{263/10}
  ...
  \begin{gather*}
    ...
    -a_1 = a_1 + 1 \quad\Rightarrow\quad a_1 = -\frac{1}{2} \\
    9a_2 + 1.5 + a_0 = 3 \quad\Rightarrow\quad a_0 = 1.5 - 9a_2 \\\\
    a_2 = k \\
    f_k(x) = kx^2 - 0.5x + 1.5 - 9k \\\\
    \text{schwarz} \\
    f_k(1) = k - 0.5 + 1.5 - 9k = 2 \quad\Rightarrow\quad k = -\frac{1}{8} \\
    f(x) = -\frac{1}{8}x^2 - \frac{1}{2}x^2 + 2.625 \\\\
    \text{rot} \\
    f_k(1) = k - 0.5 + 1.5 - 9k = 3 \quad\Rightarrow\quad k = -\frac{1}{4} \\
    f(x) = -\frac{1}{4}x^2 - \frac{1}{2}x + 3.75 \\\\
    \text{blau} \\
    f_k(1) = k - 0.5 + 1.5 - 9k = -1 \quad\Rightarrow\quad k = \frac{1}{4} \\
...
\begin{exercise}{263/11}
  \begin{gather*}
    ...
    f(x) = ax^2 + bx + c \\
    f(x) = -f(x) \quad\Rightarrow\quad b = 0 \\
    f(0) = 0 \quad\Rightarrow\quad c = 0 \\
    f(812) = ax^2 = 659344a = 189 \quad\Rightarrow\quad a \approx 2.8665 \cdot 10^{-4} \\
    f(x) = 2.8665 \cdot 10^{-4} \cdot x^2
  \end{gather*}
\end{exercise}
\begin{exercise}{263/12}
  \begin{gather*}
    SP(-1|-1) \qquad SP(1|1) \quad\Rightarrow\quad f'(\pm1) = f''(\pm1) = 0 \\
    WP(0|0) \quad\Rightarrow\quad f''(0) = 0 \\
    f(x) = ax^5 + bx^3 + cx \\\\
    f(1) = a + b + c = 1 \\
    f'(1) = 5a + 3b + c = 0 \\
    f''(1) = 20a + 6b = 0 \\\\
    ...
    \begin{vmatrix}
      ...
      4 & 2 & 0 & -1 \\
      20 & 6 & 0 & 0
    \end{vmatrix} \quad \Rmnum{2} - \Rmnum{1} \\
    \begin{vmatrix}
      1 & 1 & 1 & 1 \\
      4 & 2 & 0 & -1 \\
      8 & 0 & 0 & 3
    \end{vmatrix} \quad \Rmnum{3} - 3 \cdot \Rmnum{2} \\\\
    8a = 3 \quad\Rightarrow\quad a = \frac{3}{8} \\
    \frac{3}{2} + 2b = -1 \quad\Rightarrow\quad b = -\frac{5}{4} \\
    \frac{3}{8} - \frac{5}{4} + c = 1 \quad\Rightarrow\quad \frac{15}{8} \\\\
...
\begin{gather*}
  s = v \cdot t \qquad\text{fuer } v = const. \\
...
\begin{gather*}
  \text{Beispiel } f(x) = y = x^2 \qquad x \in \left[0; 1\right]
\end{gather*}
\begin{figure}[H]
  \centering
...
\begin{gather*}
  ...
  \qquad I = \left[0; 1\right] \Rightarrow \text{ Intervallbreite } 0.2 \rightarrow \text{ Breite der Rechtecke} \\
...
\quad $\rightarrow$ Jeder Teil ist $\frac{b}{n}$ (da $b = 1 \rightarrow \frac{1}{n}$) Längeneinheiten breit
\begin{gather*}
...
$dx$ ... Differenzial \quad $\lim\limits_{x \to 0} \Delta x = dx$ \\
...
\begin{gather*}
  \lim\limits_{n \to \infty} O_n = \frac{1}{20}a^4 \qquad fuer\quad \left[0; a\right] \\
  \lim\limits_{n \to \infty} O_n = \frac{1}{20}b^4 \qquad fuer\quad \left[0; b\right] \\
  A = \frac{1}{20}b^4 - \frac{1}{20}a^4 \qquad fuer\quad \left[a; b\right] \\\\
...
\begin{gather*}
  \text{im Beispiel} \colon F(x) = \frac{1}{20}x^4 \quad\rightarrow\quad (\frac{1}{20}x^4)' = \frac{d}{dx}(\frac{1}{20}x^4) = \frac{1}{5}x^3
\end{gather*}
\begin{exercise}{167/3}
  ...
  \item [i]
  \begin{gather*}
    f(x) = \frac{1}{8}x^4 \qquad F(x) = \frac{1}{40}x^5 \\
    \int_{-2}^{-1} \frac{1}{8}x^4 \cdot dx = F(-1) - F(-2) = 0.775
  \end{gather*}
  \item [j]
  \begin{gather*}
    f(x) = 0.5x^2 \qquad F(x) = \frac{1}{6}x^3 \\
    \int_{-4}^4 0.5x^2 \cdot dx = F(4) - F(-4) = \frac{64}{3}
  \end{gather*}
  \item [k]
  \begin{gather*}
    f(x) = x^5 \qquad F(x) = \frac{1}{6}x^6 \\
...
\begin{exercise}{168/11}
  \begin{gather*}
    v(t) = 9.81 \cdot t \qquad V(t) = s(t) = 4.905 \cdot t^2 \\
...
\begin{exercise}{168/13}
  \item [a]
  \begin{gather*}
    f(x) = x \qquad F(x) = 0.5x^2 \\
    \int_0^z x \cdot dx = 18 = F(z) - F(0) = F(z) - 0 \\
    F(z) = 18 \quad\Rightarrow\quad z = 6
  \end{gather*}
  \item [b]
  \begin{gather*}
    f(x) = 4x \qquad F(x) = 2x^2 \\
    \int_1^z 4x \cdot dx = 30 = F(z) - F(1) = F(z) - 2 \\
    F(z) = 32 \quad\Rightarrow\quad z = 4
  \end{gather*}
  \item [c]
  \begin{gather*}
    f(x) = 2x \qquad F(x) = x^2 \\
    \int_z^{10} 2x \cdot dx = 19 = F(10) - F(z) = 100 - F(z) \\
    F(z) = 81 \quad\Rightarrow\quad z = 9
  \end{gather*}
  \item [d]
  \begin{gather*}
    f(x) = 0.4 \qquad F(x) = 0.4x \\
    \int_0^{2z} 0.4 \cdot dx = 8 = F(2z) - F(0) = F(2z) - 0 \\
    F(2z) = 8 \quad\Rightarrow\quad 2z = 20 \quad\Rightarrow\quad z = 10
  \end{gather*}
\end{exercise}
\begin{exercise}{168/15}
  ...
  \begin{gather*}
    ...
    x_1 \approx -0.1213 \qquad x_2 \approx 4.1213
  \end{gather*}
  \item [b]
  \begin{gather*}
    f(x) = (x + 3)^2 \cdot (x + 1) = 0 \\
    (x + 3)^2 = 0 \quad\Rightarrow\quad x_1 = -3 \\
  ...
  \begin{gather*}
    ...
    x_1 = 0 \\
    (x^2 - 10) = -1 \quad\Rightarrow\quad x_{2/3} = \pm 3
  \end{gather*}
  \item [d]
  \begin{gather*}
    f(x) = 4 \cdot (x - 0.5)^4 - 4 = 0 \\
    (x - 0.5)^4 = 1 \quad\Rightarrow\quad x_1 = 1.5 \qquad x_2 = -0.5
  \end{gather*}
  \item [e]
  \begin{gather*}
    f(x) = e^x - e^2 = 0 \\
  ...
  \begin{gather*}
    f(x) = 0.2e^{2x} - 1 = 0 \\
    e^{2x} = 5 \quad\Rightarrow\quad x = \frac{log(5)}{2} \approx 0.8047
  \end{gather*}
\end{exercise}
